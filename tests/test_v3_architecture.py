...
def test_transport_factory():
    ...
    try:
        ...
        print(f"   [OK] STOMP傳輸層創建成功")
        print(f"      協議: {stomp.get_protocol_name()}")

        return True
    except Exception as e:
        print(f"   [FAIL] 傳輸層測試失敗: {e}")
        return False
